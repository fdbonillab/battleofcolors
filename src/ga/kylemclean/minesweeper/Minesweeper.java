...
import ga.kylemclean.minesweeper.screens.GameScreen;
...
public class Minesweeper extends Game {
    ...
    public Minesweeper( String nameAccount){
		this.nameAccount = nameAccount;
	}
	public Minesweeper( String nameAccount, Leaderboard leaderboard ){
		this.nameAccount = nameAccount;
	...
	public void create() {
		...
		setScreen(new GameScreen(this, 30, 16,0));
	}
